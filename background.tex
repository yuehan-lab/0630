...
model~\cite{swipegen2025} can generate touch trajectories whose kinematics are
...
(\textcolor{red}{$\approx$XX}~Hz on current hardware).%
...
characteristic peak amplitude of \textcolor{red}{$\approx$XX}\,mg and its
sub-50\,ms dominant duration.%
